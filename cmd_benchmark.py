...
file_dir = "/Users/larcuser/Projects/openalpr_benchmarks/endtoend/us/{}/".format(res)
openalpr_command = "docker run --rm -v /Users/larcuser/Projects/openalpr_benchmarks:/data:ro openalpr -c us endtoend/us/%s/{}"%res
results_file = "predictions_{}.csv".format(res)
...
ground_truth_annotated_dir = "/Users/larcuser/Projects/openalpr_benchmarks/img_out2/{}/ground_truth/".format(res)
predicted_annotated_dir = "/Users/larcuser/Projects/openalpr_benchmarks/img_out2/{}/predicted/".format(res)
...
def get_real_number_plate_from_txt(img_file_path):
    txt_path = img_file_path.replace('.jpg', '.txt')
    with open(txt_path, 'r') as f:
        text = f.readline()
...
def get_the_predicted_plate(img_name):
    formatted_command = openalpr_command.format(img_name)
...
for jpg_file_name in tqdm(jpg_file_list):
    ...
    truth_plate_number = get_real_number_plate_from_txt(jpg_path)
